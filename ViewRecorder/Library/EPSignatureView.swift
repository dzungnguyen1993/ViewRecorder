...
open class EPSignatureView: UIView {
    ...
    */
    ...
    var tempSignaturePath: URL = {
        let tempPath = URL(fileURLWithPath: NSTemporaryDirectory()).appendingPathComponent("tempSignature.png").absoluteString
    ...
    func saveSignatureToFile(image: UIImage) {
        if let data = UIImagePNGRepresentation(image) {
            try? data.write(to: tempSignaturePath)
        }
    }
}
